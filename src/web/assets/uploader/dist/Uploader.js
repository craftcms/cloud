...
!(function () {
  ...
  function e() {
    ...
    var _ = Object.getPrototypeOf,
      L = _ && _(_(U([])));
    L && L !== o && a.call(L, l) && (E = L);
    var C = (x.prototype = b.prototype = Object.create(E));
    function j(t) {
    ...
    function O(t, e, n) {
      ...
      return function (a, i) {
        ...
        for (n.method = a, n.arg = i; ; ) {
          ...
          var u = d(t, e, n);
          if ('normal' === u.type) {
            if (((o = n.done ? g : v), u.arg === m)) continue;
    ...
    return (
      (w.prototype = x),
      i(C, 'constructor', {value: x, configurable: !0}),
      i(x, 'constructor', {value: w, configurable: !0}),
      (w.displayName = f(x, c, 'GeneratorFunction')),
      ...
      (I.prototype = {
        ...
        delegateYield: function (t, e, n) {
          return (
            (this.delegate = {iterator: U(t), resultName: e, nextLoc: n}),
  ...
  (Craft.CloudUploader = Craft.BaseUploader.extend(
    {
      ...
      init: function (t, e) {
        ...
        (e = $.extend({}, Craft.CloudUploader.defaults, e)),
          ...
          Object.entries(this.settings.events).forEach(function (t) {
            var e = a(t, 2),
              n = e[0],
              o = e[1];
            r.element.addEventListener(n, o);
          }),
          this.allowedKinds &&
            !this._extensionList &&
          ...
          this.$dropZone &&
            this.$dropZone.on({
              ...
              drop: function (t) {
                r.handleDragEvent(t) &&
                  r.uploadFiles(t.originalEvent.dataTransfer.files);
              },
      ...
      handleDragEvent: function (t) {
        ...
        return !(
          null == t ||
          null === (e = t.originalEvent) ||
          void 0 === e ||
          null === (e = e.dataTransfer) ||
          void 0 === e ||
          !e.files ||
                      ...
                      if (
                        ...
                        (a = o.filter(function (t) {
                          var e,
                            r = !0;
                          if (
                            null !== (e = f._extensionList) &&
                            void 0 !== e &&
                            e.length
                          ) {
                            var n = t.name.match(/\.([a-z0-4_]+)$/i)[1];
                            f._extensionList.includes(n.toLowerCase()) ||
                              (f._rejectedFiles.type.push('“' + t.name + '”'),
                              (r = !1));
                          }
                          return (
                            f.settings.maxFileSize &&
                              t.size > f.settings.maxFileSize &&
                              (f._rejectedFiles.size.push('“' + t.name + '”'),
                              (r = !1)),
                            r &&
                              'function' == typeof f.settings.canAddMoreFiles &&
                              !f.settings.canAddMoreFiles(
                                f._validFileCounter,
                              ) &&
                              (f._rejectedFiles.limit.push('“' + t.name + '”'),
                              (r = !1)),
                            r &&
                              ((f._totalBytes += t.size),
                              f._validFileCounter++,
                              f._inProgressCounter++),
                            r
                          );
                        })),
                    ...
                    case 10:
                      return (
                        (a = t.sent) &&
                          ((i = a.width),
                          (s = a.height),
                          Object.assign(n, {width: i, height: s})),
                        (t.next = 14),
